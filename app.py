...
model = tf.keras.models.load_model('D:/Inteligencia artifical/taller1/mpl_model.h5')
#model = tf.keras.models.load_model(r'D:/Inteligencia artifical/taller1/mpl_model.h5')
